...
function App() {
  ...
  return (
    <div className="layout">
      {/* 왼쪽 사이드바: 앱 브랜드(큰 제목) + 메뉴. 지금은 기능이 하나뿐이지만
          나중에 기능이 늘어나도 이 nav 안에 항목만 추가하면 되는 구조입니다. */}
      <aside className="sidebar">
        <div className="brand">편집자 도우미</div>
        <nav className="side-nav">
          <div className="side-nav-item active" aria-current="page">
            색상모델 분석
          </div>
        </nav>
      </aside>
      ...
      <main className="content">
        <h2 className="page-title">색상모델 분석</h2>
